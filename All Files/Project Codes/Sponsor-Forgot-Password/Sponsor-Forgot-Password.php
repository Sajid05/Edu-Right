			 ...
			 if($count == 1) {
			 	...
			 	//Registration
			 		...
			 		$to = $email;
 				 	...
 				 	$messege = "<a href='http://www.edu-right.com/edu-right/project-code/Sponsor-Forgot-Password/Sponsor-Forgot-Password-Intermediate.php?email=$email'>Update your password</a>";
